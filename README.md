...
The default model has a 20% neutral smile, 15 facial morph controls, gaze, blinking, articulated hands, and seventeen actions with interruption blending, including globe spinning, coconut juggling, butterfly interaction, coconut headphones, initial banana routines, and independently toggleable sunglasses and headphones that stay on during other actions. The approved appearance is preserved in `References/ApprovedFanAppearance/`.
