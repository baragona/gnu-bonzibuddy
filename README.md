...
The default model has a 20% neutral smile, 15 facial morph controls, gaze, blinking, articulated hands, and twelve actions with interruption blending, including globe spinning and coconut juggling. The approved appearance is preserved in `References/ApprovedFanAppearance/`.
