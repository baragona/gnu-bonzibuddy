...
The follow-up adds torso-relative hand targets and upper-body roll, so the arms travel with the embrace instead of staying fixed while the body sways. The thumb folds are stronger, and bounded GPU pose studies informed the shoulder positions and approach/release paths. The [torso-motion checkpoint](Baselines/2026-09-05-hug-torso/README.md) records improved contact counts alongside the unresolved visual and geometric failures. The routine remains a draft.
