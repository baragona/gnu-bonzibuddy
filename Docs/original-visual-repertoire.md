...
Research date: September 5, 2026. The original's repertoire is substantially broader than our current action catalog. The working tree has twenty-five action entries, including first globe, juggling, banana, butterfly, reading, headphones, and sunglasses implementations. See [source audit and full animation directory](../References/AnimationInventory/README.md) and [sampled sprite review](../References/AnimationInventory/surfboard-sprite-review.png).
...
| Bamboo-style mailbox, empty/full outcomes, read a letter, advance, and return | Extracted: separate mail family | Initial bamboo mailbox and empty check; standalone letter read/stow added; full outcome and next-letter variants remain |
