...
| Vine entrance, exit, and travel | Extracted and reviewed: `Show` 2.70 s and `Hide` 2.60 s, with distance scaling, grip/release, and entrance landing dust | Indexed leafy vine and shared GPU bend validated; flight choreography, dust, and presence lifecycle remain missing |
