...
enum Action: String, CaseIterable {
    ...
    case write = "Write", writePause = "Write Pause"
    ...
    var duration: Double {
        ...
        case .dance: return 8
        case .globe, .juggle, .banana, .bananaMiss, .sunglasses, .headphones, .butterfly, .read, .readLookUp, .write, .writePause: preconditionFailure("Missing routine definition")
