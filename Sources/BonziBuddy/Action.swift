...
enum Action: String, CaseIterable {
    ...
    var duration: Double {
        ...
        case .dance: return 8
        case .globe, .juggle, .banana, .bananaMiss, .sunglasses, .headphones, .butterfly, .read, .readLookUp, .write, .writePause, .writeOnce, .writeAgain: preconditionFailure("Missing routine definition")
