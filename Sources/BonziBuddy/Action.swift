...
enum Action: String, CaseIterable {
    ...
    case mailEmpty = "Mail Empty", mailRead = "Mail Read"
    ...
    var duration: Double {
        ...
        case .dance: return 8
        case .globe, .juggle, .banana, .bananaMiss, .sunglasses, .headphones, .butterfly, .read, .readLookUp, .write, .writePause, .writeOnce, .writeAgain, .mailEmpty, .mailRead: preconditionFailure("Missing routine definition")
