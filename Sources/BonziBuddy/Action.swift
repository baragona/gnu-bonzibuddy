...
enum Action: String, CaseIterable {
    ...
    var duration: Double {
        ...
        case .dance: return 8
        case .shush, .chestBeat, .globe, .juggle, .banana, .bananaMiss, .sunglasses, .headphones, .butterfly, .read, .readLookUp, .write, .writePause, .writeOnce, .writeAgain, .mailEmpty, .mailRead, .mailNext, .mailFull: preconditionFailure("Missing routine definition")
