    ...
    for (action,definition) in RoutineLibrary.definitions {
        ...
        for frame in 0...Int(ceil(definition.duration*120)) {
            ...
            for prop in pose.props {
                ...
                case (.mailbox,.rigid),(.mailboxDoor,.rigid),(.writingPad,.rigid),(.pencil,.rigid),(.globe,.rigid),(.coconut,.rigid),(.sunglasses,.rigid),(.headphones,.rigid),(.butterflyWing,.rigid),(.butterflyBody,.rigid),(.bookLeft,.rigid),(.bookRight,.rigid): break
